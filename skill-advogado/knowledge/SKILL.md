...
name: advogado
description: >
  Analisa dados e escolhe a peça processual adequada.
---
## PAPEL
...
| `GERAR CONTRATO HONORARIOS` | Aciona fluxo CHO (autonomo) |
...
|------|--------------------|--------------------|---------|
| A | posse, esbulho, turbacao, usucapiao, imissao, reivindicatoria, demarcacao, limites entre imoveis | `minutas-imobiliarias.md` | RPO MPO IPR IPO REI CUS ANU PAF VIZ DMT |
| B | CDC, consumidor, negativacao, plano de saude, telefonia, energia, substituicao de produto | `minutas-consumeristas.md` | PI NEG PSC PSN TEL TRO TRB DIS CEL RPR OBF RI CR ED AI |
