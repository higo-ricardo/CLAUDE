...
Passos (todos determinísticos — nenhuma decisão de conteúdo acontece aqui):
  ...
  2. Injeta spec["referencias_formatadas"] = lista NBR 6023 já ordenada
     alfabeticamente, calculada a partir de fontes.json — o Agente Redator
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Gera o .docx final do projeto de pesquisa (NBR 15287:2025) a partir de spec.json + fontes.json."
    )
